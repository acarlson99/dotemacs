...
;;  /       ,        ,    |
;; |      /         : O /_       Oh bother...
;; |          O  .--;__   '.   Time to write more bugs than
...
#+begin_src emacs-lisp :var shrek=shrek ankylosaur=ankylosaur plesiosaur=plesiosaur corythosaur=corythosaur stegosaurus=stegosaurus coffee=coffee gaetan-juvin=gaetan-juvin pale-blue-dot=pale-blue-dot dragon=dragon pooh-bear=pooh-bear tux=tux bulbasaur=bulbasaur earth=earth dudeism=dudeism grateful-dead=grateful-dead dancing-bear=dancing-bear lambda-char=lambda-char squirtle=squirtle charmander=charmander keanu-breathtaking=keanu-breathtaking
(require 'subr-x)
(let* ((l (list
           shrek keanu-breathtaking
...
#+RESULTS:
#+begin_example
;; chumshack -- Mon Jul 10 15:59:44 2023
;;                            -:*vJzvvvlv1zxc>:-
;;                       ‘^]O#qz?*|zyoZZoy}vvi\xakur-
;;                    ,zDQNJriLumf?’-,?qNRRRW#QD2>^uQMu:
;;                 -/MQB9`\6RqHKkXUq'   `RRRRRRR8NQkr'PBNt.

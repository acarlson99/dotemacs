...
#+begin_src emacs-lisp :var shrek=shrek ankylosaur=ankylosaur plesiosaur=plesiosaur corythosaur=corythosaur stegosaurus=stegosaurus coffee=coffee gaetan-juvin=gaetan-juvin pale-blue-dot=pale-blue-dot dragon=dragon pooh-bear=pooh-bear tux=tux bulbasaur=bulbasaur earth=earth dudeism=dudeism grateful-dead=grateful-dead dancing-bear=dancing-bear lambda-char=lambda-char cromulon=cromulon squirtle=squirtle charmander=charmander keanu-breathtaking=keanu-breathtaking msg=msg pattern=pattern
  (require 'subr-x)
  (let* ((l (list
             ...
             bulbasaur squirtle charmander msg pattern
